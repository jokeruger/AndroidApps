...
public class Game4Activity extends ActionBarActivity {
	...
	TextView player3lifeView;
	TextView player4lifeView;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		player4view=(TextView)findViewById(R.id.playerView4);
    ...
    public void add1player4(View view) {
        playerLife4 += 1;
        player4lifeView.setText(""+playerLife4);
    }
    
    public void add5player4(View view) {
        playerLife4 += 5;
        player4lifeView.setText(""+playerLife4);
    }
    
    public void sub1player4(View view) {
        playerLife4 -= 1;
        player4lifeView.setText(""+playerLife4);
    }
    
    public void sub5player4(View view) {
        playerLife4 -= 5;
        player4lifeView.setText(""+playerLife4);
    }
    
    public void player4extort(View view) {
        if (playerLife1 > 0) {
            add1player4(view);
            sub1player1(view);
        }
